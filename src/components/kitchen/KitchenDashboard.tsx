...
export const KitchenDashboard: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-stone-100 flex flex-col overflow-hidden text-stone-900 font-sans">
      ...
      {/* Toolbar */}
      <div className="flex-none bg-white border-b border-stone-200 px-3 sm:px-5 py-2 sm:py-2.5 flex items-center justify-between gap-2 sm:gap-3 shadow-2xs overflow-x-auto scrollbar-hide">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-stone-100 hover:bg-stone-200 text-stone-700 text-xs font-bold transition active:scale-95 border border-stone-200 shrink-0"
        >
